...
/*! Exponential kernel */
class kernel_Exp: public H2_3D_Tree {
public:
    kernel_Exp(doft* dof, double L, int level, int n, double epsilon, int use_chebyshev):H2_3D_Tree(dof,L,level,n,epsilon, use_chebyshev){};
    virtual void setHomogen(string& kernelType);
    virtual void EvaluateKernel(vector3 fieldpos, vector3 sourcepos,
                                double *K, doft *dof);
};
